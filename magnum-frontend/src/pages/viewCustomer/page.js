                                            ...
                                            <div className="row">
                                                <div className="col-md-8 col-md-offset-2">
                                                    ...
                                                    <div className="col-md-12 profile-btn text-center">
                                                        <a href="#" onClick={()=> this.props.history.push("/listCustomer")} className="primary">BACK</a> <a href="#" onClick={() => this.props.history.push("/editCustomer")} className="primary">EDIT</a> <button className="primary" name="button">DELETE</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
